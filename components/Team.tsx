  ...
  const teamMembers = [
    {
      ...
      image: 'https://res.cloudinary.com/deasyoglq/image/upload/v1754121140/Whisk_070086fa24_teovey.jpg',
      ...
      <div className="container-mobile">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6 font-inter">
            Meet Our{' '}
            <span className="bg-gradient-to-r from-electric-pink to-deep-purple bg-clip-text text-[rgba(255,251,251,1)]">
              Expert Stylists
            </span>
          </h2>
