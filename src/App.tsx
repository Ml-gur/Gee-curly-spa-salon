...
export default function App() {
  ...
  const [selectedLocation, setSelectedLocation] = useState<'kiambu' | 'roysambu'>('kiambu') // Default to Kiambu location
        ...
        if (typeof Storage !== 'undefined') {
          ...
          if (!hasVisited) {
            ...
            if (savedLocation && (savedLocation === 'kiambu' || savedLocation === 'roysambu')) {
              setSelectedLocation(savedLocation as 'kiambu' | 'roysambu')
            }
          }
        } else {
